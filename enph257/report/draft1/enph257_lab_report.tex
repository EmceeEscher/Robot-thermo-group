...
were used.
Generally, only the data of the two middle thermocouples was used in the
optimization, as these were generally much better behaved than the edges.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{opt23}
  \caption{Example individual optimization curve: June 8 - Run 1}
  \label{fig:opt}
\end{figure}
...
\begin{table}[ht]
  ...
  \begin{tabularx}{.75\textwidth}{|X|c|c|c|c|c|c|c|c|c|}
    ...
    \rot{Writing} \\
    \hline
    Brunette, Jacob    & 25 & 45 & 26 &  7 &  0 &  0 & 40 & 25 & 25 \\
    \hline
    Fullerton, Dilyn   & 25 & 10 &  0 & 79 & 95 &  0 & 20 & 25 & 25 \\
    \hline
    Watt, Ryan         & 25 & 45 & 37 &  7 &  5 &  0 & 20 & 25 & 25 \\
    \hline
    Yao, Dickson       & 25 &  0 & 37 &  7 &  0 &100 & 20 & 25 & 25 \\
    \hline
  \end{tabularx}
\end{table}
