...
# input files
DATA_FPATHS = [
    # '../../data/temperature data/June 3/Run2_tc1_June3.dat',
    '../../data/temperature data/June 3/Run2_tc2_June3.dat',
    '../../data/temperature data/June 3/Run2_tc3_June3.dat',
    # '../../data/temperature data/June 3/Run2_tc4_June3.dat',
]
# output files
OPT_FPATH = '../results/June 3 - Run 2/params_2tcs.dat'
SIM_FPATH = '../results/June 3 - Run 2/sim_2tcs.dat'
