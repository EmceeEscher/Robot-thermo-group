...
# output files
OPT_FPATH = '../results/June 15 - Run 2/random-params-6-28.dat'
SIM_FPATH = '../results/June 15 - Run 2/random-sim-6-28.dat'
...
POWER2 = -10.
STOP_TIME = 7200.  # set to value for run listed in spreadsheet
