...
# input files
DATA_FPATHS = [
    # '../../data/temperature data/June 3/Run1_tc1_June3.dat',
    '../../data/temperature data/June 3/Run1_tc2_June3.dat',
    '../../data/temperature data/June 3/Run1_tc3_June3.dat',
    # '../../data/temperature data/June 3/Run1_tc4_June3.dat',
]
# output files
OPT_FPATH = '../results/June 3 - Run 1/params_2tcs.dat'
SIM_FPATH = '../results/June 3 - Run 1/sim_2tcs.dat'
...
EMISSIVITY = .01
POWER = 7.490667  # set to V^2/15, look in spreadsheet for V
POWER2 = -5.
STOP_TIME = 2116.  # set to value for run listed in spreadsheet
