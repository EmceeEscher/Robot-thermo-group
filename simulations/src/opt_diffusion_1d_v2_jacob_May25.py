...
DATA_FPATHS = [
    ...
    '../../data/temperature data/May 25/Run1_tc2.dat',
    '../../data/temperature data/May 25/Run1_tc3.dat',
    #'../../data/temperature data/June 8/Run1_tc4_v2.dat',
]
# output files
OPT_FPATH = '../results/May 25/random-params-6-28.dat'
SIM_FPATH = '../results/May 25/random-sim-6-28.dat'
...
POWER2 = -10.
STOP_TIME = 1200.  # set to value for run listed in spreadsheet
