...
void ServoTimer2::write(int anglevalue)
{
   this->writePulseWidth(map(anglevalue, 0, 180, 450, 1350));
}


void ServoTimer2::writePulseWidth(int pulsewidth)
{
...
//		TIMSK = ~_BV(OCIE2) | tempTIMSK ;

		TIMSK = (1<<TOIE2) | tempTIMSK ;
